...
REGION_COORDS = {
    ...
    # Andhra Pradesh
    "Visakhapatnam Coast": (17.6868, 83.2185), "Srikakulam Coast": (18.30, 83.90), "East Godavari Coast": (16.90, 82.20),
    "Krishna Coast": (16.10, 81.10), "Guntur Coast": (15.80, 80.50), "Nellore Coast": (14.4426, 79.9865),
    # Odisha
    "Puri Coast": (19.8135, 85.8312), "Ganjam Coast": (19.35, 85.05), "Balasore Coast": (21.49, 87.00),
    "Jagatsinghpur Coast": (20.00, 86.40), "Kendrapara Coast": (20.50, 86.60),
    # Maharashtra
    "Mumbai City Coast": (18.93, 72.82), "Mumbai Suburban Coast": (19.10, 72.85), "Raigad Coast": (18.50, 72.90),
    ...
    "Surat Coast": (21.17, 72.83), "Valsad Coast": (20.60, 72.90),
    # West Bengal
    "Purba Medinipur Coast": (21.90, 87.70), "South 24 Parganas Coast": (21.70, 88.50),
    # UTs
    "Puducherry Region Coast": (11.9416, 79.8083), "Karaikal Coast": (10.92, 79.83),
    "Port Blair": (11.6234, 92.7265), "Kavaratti": (10.56, 72.64),
